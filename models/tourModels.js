...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      //validate: [validator.isAlpha, 'Enter Only Characters']
    },
    slug: String,
    duration: {
      type: Number,
    ...
    difficulty: {
      ...
      // THE ENUM VALIDATOR IS ONLY USED FOR STRINGS
      enum: {
    ...
    ratingsAverage: {
      type: Number,
      default: 4.5,
      //THE MIN AND MAX VALIDATOR IS USED FOR NUMBERS AND DATE
...
//tourSchema.index({ price, ratingsAverage})
