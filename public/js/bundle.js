...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieHJpcy1nYWJyaWVsIiwiYSI6ImNsbGdodWVoMDE1cm4zaXF5YmhqODlvdHgifQ.D0bh24s6owHtylEx8qt_kQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11',
    scrollZoom: false
  });
  var bounds = new mapboxgl.LngLatBonds();
  locations.forEach(function (loc) {
    // Create marker
    var el = document.createElement('div');
    'marker', _readOnlyError("el"); // Add marker
